...
threads="39"
gff_dir="output/miniProt_alignments/filtered_mRNA_stop_frameshift_ATG"
...
parallel -j $threads "bash src/08_associationModeling/pullIntrons.sh $gff_dir/{}.gff | \
...
Rscript src/08_associationModeling/NucFreqsToCSV.R output/background_nuc_freqs/nucFreqs/ output/modelData/nucFreqs_shortIntrons.csv

...
source(paste0(rootDir,"src/06_motifTurnover/load_motif_data.R")) 
...
# Create histogram
taxa_per_og_plot <- ggplot(taxa_per_og_df, aes(x = n_taxa)) +
...
ggsave(paste0(rootDir, "results/figs/taxa_per_og.png"), plot = taxa_per_og_plot, width = 8, height = 8, units = "in", dpi = 1500)
```

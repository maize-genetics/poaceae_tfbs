...
all_og_conservation <- prepped.motifs[["HSF_GARP"]]
chip_conservation <- chip.prepped.motifs[["HSF_GARP"]]
...
plot(
  ...
  xlab = "All OGs: % HSF/GARP motifs Conserved",
  ylab = "ChIP OGs: % HSF/GARP motifs Conserved",

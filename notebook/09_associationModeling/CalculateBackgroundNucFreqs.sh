...
parallel -j $threads "bash src/pullIntrons.sh $gff_dir/{}.gff | \
...
Rscript src/NucFreqsToCSV.R output/background_nuc_freqs/nucFreqs/ output/modelData/nucFreqs_shortIntrons.csv

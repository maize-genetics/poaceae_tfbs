#!/bin/bash
# Scans UMR and ACR regions for motifs using FIMO and compares to dinucleotide shuffled background sequences across five species.
...
for species in "${umr_key[@]}"; do
  ...
  bash src/04_motifEnrichment/ScanFeatureIntervals.sh \

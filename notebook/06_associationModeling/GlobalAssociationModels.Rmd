...
nucFreqs <- read.csv("/workdir/coh22/andro_tfbs/output/modelData/nucFreqs_shortIntrons.csv")
...
write.table(sorted_results, file="/workdir/coh22/andro_tfbs/results/models/model_globalOcc_envPC1.10.csv", sep = ",", quote = F, row.names = F)
```

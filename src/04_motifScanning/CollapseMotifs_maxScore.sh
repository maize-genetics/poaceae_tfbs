...
# Retains the score of the highest scoring motif instance for each overlapping region
...
# Charlie Hale, 2025.06.07 chale295@gmail.com
...
NR > 1 && $0 !~ /^#/ && $0 != "" {
  ...
  motifID = $1;
  score = $7;
  print seqName, start, stop, motifID, score;
...
awk -v OFS='\t' '{print $2, $3, $4,  $1, $6, $5}' > "$motifs_with_cluster_info"
rm "$key_to_join"
